...
class ResumeGenerator:
    ...
    def process_resume(self, resume_data: Resume, output_dir: str = "resume/latex_resume_generator/output") -> tuple[str, str, str, str]:
        """
...
def main():
    ...
    generator.process_resume(resume_data, output_dir="resume/latex_resume_generator/output")
