...
\leftheader{%
  {\LARGE\bfseries\sffamily First Last}

  \makefield{\faEnvelope[regular]}{\href{mailto:email@example.com}{\texttt{email@example.com}}}
  \makefield{\faPhone}{+1-234-567-8900}
  \makefield{\faLinkedin}
  {\href{https://linkedin.com/in/username}{\texttt{linkedin.com/in/username}}}
  \makefield{\faGithub}{\href{https://github.com/username}{\texttt{github.com/username}}}
}
...
{Company Name}
{Location}
{Job description and achievements go here.}
\end{eventlist}
\end{rubric}
...
{Institution}
{Location}
{Details about education, GPA, relevant coursework, etc.}
\end{eventlist}
\end{rubric}
