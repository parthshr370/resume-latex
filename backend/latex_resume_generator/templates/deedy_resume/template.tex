...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{First}{Last}{\urlstyle{same}\href{http://example.com}{http://example.com}| \href{http://example2.com}{http://example2.com} \\
\href{mailto:user@example.com}{user@example.com} | 000.000.0000 | \href{mailto:other@example.com}{other@example.com}
}
...
\location{Grad. May 2011|  Location, ST}
\sectionsep
